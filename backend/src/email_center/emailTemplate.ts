  ...
  const html = `
    ...
    <body>
        <div class="container">
            ...
            <p>If you need assistance, please contact our support team at [support@election.america.com].</p>
            <p>We appreciate your cooperation in maintaining the integrity and security of our systems and data.</p>
            <p>Warm regards,<br>American Election Committee<br>Desk Committee<br>codetyper.america@gmail.com</p>
        </div>
    </body>
    </html>
