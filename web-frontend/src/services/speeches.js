...
export const UltimateSpeech = async (results) => {
    if (results.candidatesResult.length === 0)
        return;
    const winnerResult = results.candidatesResult.find(x => x.candidate.name === results.winner.name);
    if (!winnerResult) {
...
export const Mockresults = {
    ...
    candidatesResult: [
        ...
        { numVotes: 20, percentage: 66.67, candidate: { id: 2, code: 2, name: "Abrar Ahmed", acronym: "AM", party: "Party B", status: "verified", toast: () => { } } },
